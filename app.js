...
const democraticPresidents = presidents.filter(function (democratic) {
  if (democratic.party === 'D') {
    return true;
  }
});
...
const demsTwoTerms = presidents.filter(function (name) {
  if (name.terms === 2 && name.party === 'D') {
    return true;
  }
}); 
